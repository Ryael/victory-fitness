...
The home page takes the approach where all of the content in the body occupies approxtimately 70% of the width available on the page. The about, coaching, gallery, and contact pages meanwhile take a different albeit consistent approach with a much [shorter hero image](docs/features/hero-small-image.png). This is to establish a sense of flow familarity with the design of the website for new users. This is then further accompanied by a transparent navigation bar on wider resolutions, a black-background hamburger menu for smaller resolutions, and a light grey footer. The footer is the same throughout all of the website at all viewpots. The about, coaching, gallery, and contact pages take a very similar approach to the home page in the design of their bodies, using approximately 70% of the available width on larger resolutions. However, where they differ is in how images are displayed: background images always occupy 100% of the available width, whereas inline images only occupy the same amount of width as the body. This is a conscious design decision to allow for the body text to sleekly wrap under any images present, allowing for a neat and tidy viewing experience.
